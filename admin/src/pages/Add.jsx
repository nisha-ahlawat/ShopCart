...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3 px-5 m-10">
      <div className="">
      ...
      <div className="flex flex-col gap-3 sm:flex-row w-full sm:gap-8">
        <div>
      ...
      <button className="text-white bg-black mt-4 py-3 text-sm w-28 rounded cursor-pointer">
        {" "}
        ADD
      </button>
    </form>
